        ...
        value: function render() {
            ...
            return readOnly ? React.createElement(CannerEditor, {
                ...
                React.createElement(
                    EditorContainer,
                    { isFull: isFull },
                    React.createElement(CannerEditor, _extends({
    ...
    _createClass(CannerEditor, [{
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                rest = _objectWithoutProperties(_props2, ['value', 'onChange', 'readOnly']);

            return React.createElement(_slateReact.Editor, _extends({
